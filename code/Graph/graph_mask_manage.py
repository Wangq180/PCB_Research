...
def main():
    filename = 'sorted_data——mask.txt'  # 更正文件名
    save_path = 'model_performance_comparison.png'  # 指定保存图像的路径
    dcnn_psnr, edsrn_psnr, resnet_psnr, dcnn_mse, edsrn_mse, resnet_mse = parse_data(filename)
    plot_data([dcnn_psnr, edsrn_psnr, resnet_psnr], [dcnn_mse, edsrn_mse, resnet_mse], 'Mask sort', save_path)
